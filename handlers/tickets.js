const { asegurar_todo } = require("../utils/functions.js")
...
module.exports = client => {
    ...
    client.on("interactionCreate", async interaction => {
        try {
            ...
            await interaction.reply({ content: "⌛ **Creando tu ticket... Por favor espere**", ephemeral: true })
            //creamos el canal
            const channel = await interaction.guild.channels.create({
                name: `┊-🎫-ɞ┇ticket-${interaction.member.user.username}⊹‧˚`.substring(0, 50),
